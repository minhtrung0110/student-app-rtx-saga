...
// Api
import { setCookies } from 'src/api/authApi';
        ...
        <FormContainer onSubmit={e => e.preventDefault()}>
          ...
          <RememberMeContainer>
            <div className="flex items-center gap-x-3">
              <CheckboxInput type="checkbox" id="remember-me-checkbox" />
              <CheckboxLabel htmlFor="remember-me-checkbox"></CheckboxLabel>
              <span>Remember me</span>
            </div>
            <ForgotPasswordLink href="javascript:void(0)">Forgot password?</ForgotPasswordLink>
          </RememberMeContainer>
          <SubmitButton onClick={handleClickLogin}>Sign in</SubmitButton>
        </FormContainer>
        <SocialButton>
          <svg
            className="w-5 h-5"
